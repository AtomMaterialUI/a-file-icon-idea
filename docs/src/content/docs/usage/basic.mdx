...
Once installed, the plugin automatically replaces standard file and folder icons with vibrant, context-aware icons based on file extensions,
frameworks, and specific naming conventions.
...
import withAllBasic from "../../../assets/screens/withAll.png";

<ImageWrapper
src={withAllBasic}
alt="Atom Material Icons"
